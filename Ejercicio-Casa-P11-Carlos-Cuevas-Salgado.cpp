...
/*------------- Alumno: Carlos Cuevas Salgado
	...
	Instrucciones : Para moverse atraves de la pnatalla se utilizaran las siguiente teclas :
		  ...
		  Con la tecla P el carro se detiene
		  Con la tecla espaciadora el carro avanza
		  Con la tecla R/D cambia de direccion
		  Con la tecla N se disminuye la velocidad
		  Con la tecla M se aumenta la velocidad

		  **Por default el carro avanza hacia adelante
...
//For model
float	movKit_z = -60.0f, velocidad = 1.0f,
		movKit_x = -15.0f,
		movKit_y = 0.0f,
		rotKit_y = 0.0f,
		incremento = 1.0f;
