...
/*
	...
	Instrucciones: Para moverse atraves de la pnatalla se utilizaran las siguiente teclas:
					...
					Para dibujar un cubo se usa la siguiente función: glDrawArrays(GL_QUADS, 0, 24);
					
					Para mover el cubo se utiliza las siguiente lineas:
					                                             //Posicion en X,Y,Z
							model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
							projectionShader.setMat4("model", model);
                    Para darle color se utiliza:    
												//Se coloca en RGB			
	                        projectionShader.setVec3("newColor", 1.0f, 0.69f, 0.69f);


	Objetivo: Escribir hacer un dibujo usando solamente cuadrados, debera mandarse el color.
*/
#include <glew.h>
#include <glfw3.h>
...
int SCR_WIDTH = 3800;
int SCR_HEIGHT = 7600;
//Variables de control para desplazarse en el eje X, Y y Z
float movX = 0.0f;
float movZ = 0.0f;
float movY = 0.0f;
...
void display(void)
{
	...
	//En la siguiente parte se van dibujando los cuadrados. 
	glBindVertexArray(VAO);
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("newColor", 1.0f, 0.86f, 0.86f);
	...
	projectionShader.setVec3("newColor", 1.0f, 1.0f, 1.0f);
	...
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("newColor", 0.423f, 0.270f, 0.274f);
...
void my_input(GLFWwindow *window)
{
	...
	//Se le asocia un movimiento a las taclas para poder navegar
