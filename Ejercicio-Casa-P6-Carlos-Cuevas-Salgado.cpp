...
/* ----------------   Práctica 6 --------------------------*/
/*-----------------    2019-2   ---------------------------*/
/*------------- Computación gráfica e interacción humano computadora ---------------Autor: Carlos Cuevas Salgado
	Grupo de laboratorio : 03
	Grupo de Teoria : 01
	Fecha de entrega 14 de Marzo de 2019
	Version de Visual 2017
	Objetivo: Hacer una representación del modelo atomico
...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.67f, 0.67f));
	sphere_draw();
